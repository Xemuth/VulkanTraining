...
Upp::String ToStringMemoryType(const VkMemoryType& memoryType, int numTab){
	Upp::String str;
...
Upp::String ToStringMemoryHeap(const VkMemoryHeap& memoryHeap, int numTab){
	Upp::String str;
...
Upp::String ToStringExtent3D (const VkExtent3D& vkE3D, int numTab){
	Upp::String str;
...
Upp::String ToStringPhysicalDeviceMemoryProperties(const VkPhysicalDeviceMemoryProperties& vkPDMP, int numTab){
	Upp::String str;
...
Upp::String ToStringPhysicalDeviceFeatures(const VkPhysicalDeviceFeatures& vkPDF, int numTab){
	Upp::String str;
...
Upp::String ToStringPhysicalDeviceProperties(const VkPhysicalDeviceProperties& vkPDP, int numTab){
	Upp::String str;
...
Upp::String ToStringQueueFamilyProperties(const VkQueueFamilyProperties& vkQFP, int numTab){
	Upp::String str;
